  ...
  return (
    <div className="app-shell">
      ...
      <div className="main-area">
        <header className="topbar"><span><span className="crumb">训练中心</span> / {({ hall: '面试大厅', interview: '技术面试', history: '面试记录', report: '训练复盘' })[view]}</span><span className="top-tag">FRONTEND INTERVIEW · V0.1</span></header>
